...
class $ItemsTable extends Items with TableInfo<$ItemsTable, ItemData> {
  ...
  ItemData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ItemData(
      ...
      status: $ItemsTable.$converterstatus.fromSql(attachedDatabase.typeMapping
  ...
  static TypeConverter<ItemStatus, int> $converterstatus =
...
class ItemData extends DataClass implements Insertable<ItemData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['status'] = Variable<int>($ItemsTable.$converterstatus.toSql(status));
    }
    map['created_at'] = Variable<DateTime>(createdAt);
...
class ItemsCompanion extends UpdateCompanion<ItemData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (status.present) {
      map['status'] =
          Variable<int>($ItemsTable.$converterstatus.toSql(status.value));
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
    }
